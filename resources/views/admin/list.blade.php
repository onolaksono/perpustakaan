            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a href="#"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a></li>
                        <li><a href="#"><i class="fa fa-book"></i><span class="hide-menu">Data Buku</span></a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body"> Hello,  {{ Auth::user()->nama }}. Ini adalah halaman buku </div>
                        </div>
                    </div>
                </div>
                <!-- End PAge Content -->
